...
These are interactive solutions with `R` code. You can typically modify allocations or parameters in the utility functions to graphically see how it affects the results.
